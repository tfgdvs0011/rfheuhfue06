...
const UUIDS = [
'dfc964fa-55b9-4cfd-93cc-adbb512b4440',
'45a56c73-a6ff-477a-9496-7dc34f027f6f',
'1f6e55a3-7fe4-4ddd-a440-6b23ee8994db',
'7ffac1a6-7dfe-4db5-ab18-514da6faaa17',
'84079654-a490-47f2-9d96-6b63d151d11d',
];

// 订阅地址后缀（这里需要修改一下，可以随便输入一些字母或数字）
const SUB_PATH = 'iodhjserddy';

// XHTTP 路径（这里需要修改一下，可以随便输入一些字母或数字）
const XPATH = 'fhueuwe9230';
